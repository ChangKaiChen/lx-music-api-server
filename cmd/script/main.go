...
import (
	"context"
	"github.com/ChangKaiChen/lx-music-api-server/app/script/config"
	"github.com/ChangKaiChen/lx-music-api-server/app/script/rpc"
...
const serviceName = consts.ScriptServiceName
...
func main() {
	...
	svr := scriptservice.NewServer(new(rpc.ScriptHandler), opts...)
