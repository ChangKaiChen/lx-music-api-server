...
func (p *MgRequest) FastRead(buf []byte) (int, error) {
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MgRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_MgRequest[fieldId]))
}

func (p *MgRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *MgRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *MgRequest) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *MgRequest) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *MgRequest) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *MgRequest) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *MgRequest) field1Length() int {
	l := 0
...
func (p *MgRequest) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *MgResponse) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MgResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_MgResponse[fieldId]))
}

func (p *MgResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *MgResponse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *MgResponse) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *MgResponse) FastReadField4(buf []byte) (int, error) {
	offset := 0
	_field := NewExtra()
...
func (p *MgResponse) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *MgResponse) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *MgResponse) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *MgResponse) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 2)
...
func (p *MgResponse) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *MgResponse) fastWriteField4(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *MgResponse) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *MgResponse) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *MgResponse) field3Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *MgResponse) field4Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Extra.BLength()
	return l
...
func (p *MgServiceMgMusicUrlArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MgServiceMgMusicUrlArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *MgServiceMgMusicUrlArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	_field := NewMgRequest()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *MgServiceMgMusicUrlArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *MgServiceMgMusicUrlArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *MgServiceMgMusicUrlArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *MgServiceMgMusicUrlArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *MgServiceMgMusicUrlArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Req.BLength()
	return l
...
func (p *MgServiceMgMusicUrlResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MgServiceMgMusicUrlResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *MgServiceMgMusicUrlResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
	_field := NewMgResponse()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
...
func (p *MgServiceMgMusicUrlResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *MgServiceMgMusicUrlResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *MgServiceMgMusicUrlResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *MgServiceMgMusicUrlResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *MgServiceMgMusicUrlResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *MgServiceMgMusicUrlArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *MgServiceMgMusicUrlResult) GetResult() interface{} {
	return p.Success
}
