...
func (p *KgRequest) FastRead(buf []byte) (int, error) {
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_KgRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_KgRequest[fieldId]))
}

func (p *KgRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *KgRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *KgRequest) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *KgRequest) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *KgRequest) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *KgRequest) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *KgRequest) field1Length() int {
	l := 0
...
func (p *KgRequest) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *KgResponse) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_KgResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_KgResponse[fieldId]))
}

func (p *KgResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *KgResponse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *KgResponse) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *KgResponse) FastReadField4(buf []byte) (int, error) {
	offset := 0
	_field := NewExtra()
...
func (p *KgResponse) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *KgResponse) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *KgResponse) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *KgResponse) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 2)
...
func (p *KgResponse) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *KgResponse) fastWriteField4(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *KgResponse) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *KgResponse) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *KgResponse) field3Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *KgResponse) field4Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Extra.BLength()
	return l
...
func (p *KgServiceKgMusicUrlArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_KgServiceKgMusicUrlArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *KgServiceKgMusicUrlArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	_field := NewKgRequest()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *KgServiceKgMusicUrlArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *KgServiceKgMusicUrlArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *KgServiceKgMusicUrlArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *KgServiceKgMusicUrlArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *KgServiceKgMusicUrlArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Req.BLength()
	return l
...
func (p *KgServiceKgMusicUrlResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_KgServiceKgMusicUrlResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *KgServiceKgMusicUrlResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
	_field := NewKgResponse()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
...
func (p *KgServiceKgMusicUrlResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *KgServiceKgMusicUrlResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *KgServiceKgMusicUrlResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *KgServiceKgMusicUrlResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *KgServiceKgMusicUrlResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *KgServiceKgMusicUrlArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *KgServiceKgMusicUrlResult) GetResult() interface{} {
	return p.Success
}
