...
import (
	"context"
	"github.com/ChangKaiChen/lx-music-api-server/app/kw/config"
	"github.com/ChangKaiChen/lx-music-api-server/app/kw/rpc"
...
const serviceName = consts.KwServiceName
...
func main() {
	...
	svr := kwservice.NewServer(new(rpc.KwHandler), opts...)
