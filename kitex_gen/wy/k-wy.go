...
func (p *WyRequest) FastRead(buf []byte) (int, error) {
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_WyRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_WyRequest[fieldId]))
}

func (p *WyRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *WyRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *WyRequest) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *WyRequest) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *WyRequest) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *WyRequest) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *WyRequest) field1Length() int {
	l := 0
...
func (p *WyRequest) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *WyResponse) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_WyResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_WyResponse[fieldId]))
}

func (p *WyResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *WyResponse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *WyResponse) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *WyResponse) FastReadField4(buf []byte) (int, error) {
	offset := 0
	_field := NewExtra()
...
func (p *WyResponse) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *WyResponse) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *WyResponse) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *WyResponse) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 2)
...
func (p *WyResponse) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *WyResponse) fastWriteField4(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *WyResponse) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *WyResponse) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *WyResponse) field3Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *WyResponse) field4Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Extra.BLength()
	return l
...
func (p *WyServiceWyMusicUrlArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_WyServiceWyMusicUrlArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *WyServiceWyMusicUrlArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	_field := NewWyRequest()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *WyServiceWyMusicUrlArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *WyServiceWyMusicUrlArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *WyServiceWyMusicUrlArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *WyServiceWyMusicUrlArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *WyServiceWyMusicUrlArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Req.BLength()
	return l
...
func (p *WyServiceWyMusicUrlResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_WyServiceWyMusicUrlResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *WyServiceWyMusicUrlResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
	_field := NewWyResponse()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
...
func (p *WyServiceWyMusicUrlResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *WyServiceWyMusicUrlResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *WyServiceWyMusicUrlResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *WyServiceWyMusicUrlResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *WyServiceWyMusicUrlResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *WyServiceWyMusicUrlArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *WyServiceWyMusicUrlResult) GetResult() interface{} {
	return p.Success
}
