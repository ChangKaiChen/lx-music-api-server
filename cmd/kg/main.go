...
import (
	"context"
	"github.com/ChangKaiChen/lx-music-api-server/app/kg/config"
	"github.com/ChangKaiChen/lx-music-api-server/app/kg/rpc"
...
const serviceName = consts.KgServiceName
...
func main() {
	...
	svr := kgservice.NewServer(new(rpc.KgHandler), opts...)
